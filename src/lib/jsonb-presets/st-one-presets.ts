...

  {
    ...
    definition: {
      fields: [
        ...
        SKU_FIELD,
        { key: 'time_total',               type: 'number', pgCast: 'float8' },
        { key: 'time_run',                 type: 'number', pgCast: 'float8' },
        { key: 'time_stop',                type: 'number', pgCast: 'float8' },
        { key: 'stop_count',               type: 'number', pgCast: 'float8' },
        { key: 'time_scheduled',           type: 'number', pgCast: 'float8' },
        { key: 'time_unscheduled',         type: 'number', pgCast: 'float8' },
        { key: 'time_planned',             type: 'number', pgCast: 'float8' },
        { key: 'time_planned_maintenance', type: 'number', pgCast: 'float8' },
        { key: 'time_planned_sanitation',  type: 'number', pgCast: 'float8' },
        { key: 'time_planned_changeover',  type: 'number', pgCast: 'float8' },
        { key: 'time_planned_breaks',      type: 'number', pgCast: 'float8' },
        { key: 'time_unplanned',           type: 'number', pgCast: 'float8' },
        { key: 'time_unplanned_logistics', type: 'number', pgCast: 'float8' },
        { key: 'time_unplanned_breakdown', type: 'number', pgCast: 'float8' },
        { key: 'time_unplanned_process',   type: 'number', pgCast: 'float8' },
        { key: 'prod_target',              type: 'number', pgCast: 'float8' },
        { key: 'time_prod_main',           type: 'number', pgCast: 'float8' },
        { key: 'time_prod_out',            type: 'number', pgCast: 'float8' },
        { key: 'prod_main',                type: 'number', pgCast: 'float8' },
        { key: 'prod_out',                 type: 'number', pgCast: 'float8' },
        { key: 'prod_main_machine',        type: 'number', pgCast: 'float8' },
        { key: 'prod_out_machine',         type: 'number', pgCast: 'float8' },
      ],
    },
